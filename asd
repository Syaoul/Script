...
function Library:Create(table)
    ...
    main.Position = UDim2.fromScale(0.245, 0.290)
    main.Size = UDim2.fromOffset(485, 300)
    ...
    title.Size = UDim2.fromOffset(85, 30)
    title.Parent = main
    ...
    close.MouseButton1Click:Connect(function()
        game:GetService("CoreGui"):FindFirstChild("Dark"):Destroy()
    end)
    ...
    Enabled.MouseButton1Click:Connect(function()
        game:GetService("CoreGui").Dark.Visible = false
    end)
        ...
        local Input = main.InputBegan:connect(function(Key)
            if Key.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                while RunService.RenderStepped:wait() and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) do
                    local FrameX, FrameY = math.clamp(Mouse.X - ObjectPosition.X, 0, Dark.AbsoluteSize.X - main.AbsoluteSize.X), math.clamp(Mouse.Y - ObjectPosition.Y, 0, Dark.AbsoluteSize.Y - main.AbsoluteSize.Y)
